...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index.php" class="h1"><b>Jay</b>Auto</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Register a new Admin</p>

      <form action="includes/processes/register.php" method="post">
      ...
      <a href="login.html" class="text-center">Registered already</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
